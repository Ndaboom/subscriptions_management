...
public class ListeEmploye extends javax.swing.JInternalFrame {
        ...
        try{
            ...
            while(resultat.next()){
                model.addRow(new Object [] {resultat.getString("nom"),resultat.getString("prenom"), resultat.getString("sexe"),
                    resultat.getDate("date_naissance"),resultat.getString("lieu_naissance"),resultat.getString("profession"),
                    resultat.getString("date_enregistrement"),resultat.getString("statut_membre"),resultat.getString("telephone"),resultat.getString("email")
                });
            }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Liste des membres"));
