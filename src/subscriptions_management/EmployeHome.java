...
public class EmployeHome extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTDateEnreg = new com.toedter.calendar.JDateChooser();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Informations supplementaires"));
        ...
        jTProfession.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTPosteKeyTyped(evt);
            }
        });
        ...
        jCStatut.setModel(new DefaultComboBoxModel(new String[] {"Actif", "Non actif"}));

        jTDateEnreg.setDateFormatString("yyyy-MM-dd");
        jTDateEnreg.setMinSelectableDate(new java.util.Date(-2208967355000L));
        ...
        jPanel3Layout.setHorizontalGroup(
        	jPanel3Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel3Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(jCStatut, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)
        				.addComponent(jTDateEnreg, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)
        				.addComponent(jTProfession, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 135, GroupLayout.PREFERRED_SIZE)))
        );
    ...
    private void jBValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBValiderActionPerformed
        ...
        if(dataStatu==true){
            ...
            try{
            String requete="INSERT INTO membres(nom, prenom, sexe, date_naissance, lieu_naissance, profession, date_enregistrement,statut_membre, telephone, email)value ('"+nomrecup+"','"+prenomrecup+"','"+sexerecup+"','"+daterecup+"','"+lieurecup+"','"+posterecup+"','"+dateembrecup+"','"+statutrecup+"','"+telrecup+"','"+emailrecup+"')";
...
if(doPrint) {
    ...
    private com.toedter.calendar.JDateChooser jTDateEnreg;
